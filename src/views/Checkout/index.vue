...
const createOrder = async () => {
  const res = await createOrderAPI({
    ...
    payChannel: 1,
    buyerMessage: '',
    goods: cartStore.selectedCartList.map(item => {
      return {
        skuId: item.skuId,
        count: item.count
      }
      ...
      <div class="wrapper">
        ...
        <div class="box-body">
          <div class="address">
            ...
            <div class="action">
              <el-button size="large" type="primary" @click="showDialog = true">切换地址</el-button>
              <el-button size="large" type="primary">添加地址</el-button>
            </div>
          </div>
        </div>
        <!-- 商品信息 -->
        ...
        <div class="box-body">
          <table class="goods">
            ...
            <tbody>
              <tr v-for="i in cartStore.selectedCartList" :key="i.id">
                <td>
