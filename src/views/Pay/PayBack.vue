  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-result">
        ...
        <p class="tip">{{ $route.query.payResult === 'true' ? '我们将尽快为您发货，收货期间请保持手机畅通' : '请重新进行支付' }}</p>
        <p>支付方式：<span>支付宝</span></p>
        <p>支付金额：<span>¥{{ orderInfo.payMoney?.toFixed(2) }}</span></p>
        <div class="btn">
          <el-button type="primary" style="margin-right:20px" @click="$router.push('/cartlist')">回到购物车</el-button>
